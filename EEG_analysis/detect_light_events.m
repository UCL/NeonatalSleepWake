...
assert(numel(params.light_threshold_std) == 1 || ...
    numel(params.light_threshold_std) == width(data_table) - 1 , ...
    'Number of light event threshold parameters should either be 1 or equal to the number of columns');
